...
#p1 = pylab.plot(model.data["node_1"], 'ob-')
#p2 = pylab.plot(model.data["node_2"], 'sr-')
#p3 = pylab.plot(model.data["node_3"], 'ob-')
#pylab.legend( [p3], ["node_3"])
#pylab.title('ST14')
#pylab.ylim((-0.5,1.5))
#pylab.xlim((0.0, 20))
#pylab.show()
